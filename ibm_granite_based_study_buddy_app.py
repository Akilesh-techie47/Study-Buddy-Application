# -*- coding: utf-8 -*-
"""IBM granite based Study Buddy app.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1knIuQ3gARAhEKKQU9nUGs_fFqf593pzy
"""
...
def extract_frames(video_path, frame_rate=30):
    ...
    while cap.isOpened():
        ret, frame = cap.read()
        if not ret: break
        if idx % frame_rate == 0:  # take one frame every `frame_rate`
            frames.append(frame)
        idx += 1
    cap.release()
    return frames
